import {txDecode} from '../src/index'
...
test('txDecode', () => {
    ...
    let expected = {
        signature:
            {
                sender:
                    'yee1gjjlh3ll709jvdvwvpc0helpw8uh3fdldh3ae3a6xkdm0qu3d4zqg2d5d3',
                signature:
        ...
        call:
            {
                ...
                params:
                    {
                        dest:
                            'yee1x6c3d0x7la4lvdfee63u4lwepw6n6m0sgwew77gaydxf9jjaaqzqzzu8dj',
                        value: 200000000000
                    }
            }
    }
